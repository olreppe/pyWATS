...
namespace Virinco.WATS.Interface
{
    internal class Processes
    {
        ...
        internal void Load()
        {
            ...
            {
                var reader = new Virinco.Newtonsoft.Json.JsonTextReader(txtreader);
                var serializer = new Virinco.Newtonsoft.Json.JsonSerializer();
        ...
        internal void Save()
        {
            ...
            {
                var writer = new Virinco.Newtonsoft.Json.JsonTextWriter(txtwriter);
                var serializer = new Virinco.Newtonsoft.Json.JsonSerializer();
        ...
        internal void Get(bool save = true)
        {
            ...
            using (var tReader = new StreamReader(res))
            {
                ...
                var procs = conv.Deserialize(jReader) as Virinco.Newtonsoft.Json.Linq.JArray;
                var filteredprocs =
