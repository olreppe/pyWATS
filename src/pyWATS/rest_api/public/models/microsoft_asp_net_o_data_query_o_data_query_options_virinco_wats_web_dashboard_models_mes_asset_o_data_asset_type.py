...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type_if_none_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfNoneMatch
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type_request import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeRequest
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type_if_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfMatch
...
T = TypeVar("T", bound="MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetType")



@_attrs_define
class MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetType:
    """ 
        Attributes:
            if_match (Union[Unset,
                MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfMatch]):
            if_none_match (Union[Unset,
    ...
    if_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfMatch'] = UNSET
    if_none_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfNoneMatch'] = UNSET
    request: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeRequest'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfMatch]
        if isinstance(_if_match,  Unset):
            if_match = UNSET
        else:
            if_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfMatch.from_dict(_if_match)




        _if_none_match = d.pop("IfNoneMatch", UNSET)
        if_none_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfNoneMatch]
        if isinstance(_if_none_match,  Unset):
            if_none_match = UNSET
        else:
            if_none_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeIfNoneMatch.from_dict(_if_none_match)




        _request = d.pop("Request", UNSET)
        request: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeRequest]
        if isinstance(_request,  Unset):
            request = UNSET
        else:
            request = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetTypeRequest.from_dict(_request)
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type = cls(
            if_match=if_match,
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type.additional_properties = d
        return microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_type
