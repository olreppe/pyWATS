...
from ..models.microsoft_o_data_edm_i_edm_property_property_kind import MicrosoftODataEdmIEdmPropertyPropertyKind
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="MicrosoftODataEdmIEdmProperty")
...
class MicrosoftODataEdmIEdmProperty:
    """ 
        Attributes:
            property_kind (Union[Unset, MicrosoftODataEdmIEdmPropertyPropertyKind]):
            type_ (Union[Unset, MicrosoftODataEdmIEdmTypeReference]):
            declaring_type (Union[Unset, MicrosoftODataEdmIEdmStructuredType]):
            name (Union[Unset, str]):
     """

    property_kind: Union[Unset, MicrosoftODataEdmIEdmPropertyPropertyKind] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_property_kind,  Unset):
            ...
            property_kind = MicrosoftODataEdmIEdmPropertyPropertyKind(_property_kind)
        ...
        microsoft_o_data_edm_i_edm_property = cls(
        ...
        microsoft_o_data_edm_i_edm_property.additional_properties = d
        return microsoft_o_data_edm_i_edm_property
