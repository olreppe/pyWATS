...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_validators_top_query_validator import MicrosoftAspNetODataQueryValidatorsTopQueryValidator





T = TypeVar("T", bound="MicrosoftAspNetODataQueryTopQueryOption")
...
class MicrosoftAspNetODataQueryTopQueryOption:
    """ 
        Attributes:
            ...
            validator (Union[Unset, MicrosoftAspNetODataQueryValidatorsTopQueryValidator]):
     """

    context: Union[Unset, 'MicrosoftAspNetODataODataQueryContext'] = UNSET
    raw_value: Union[Unset, str] = UNSET
    value: Union[Unset, int] = UNSET
    validator: Union[Unset, 'MicrosoftAspNetODataQueryValidatorsTopQueryValidator'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_validator,  Unset):
            ...
            validator = MicrosoftAspNetODataQueryValidatorsTopQueryValidator.from_dict(_validator)




        microsoft_asp_net_o_data_query_top_query_option = cls(
            context=context,
            raw_value=raw_value,
            value=value,
            validator=validator,
        ...
        microsoft_asp_net_o_data_query_top_query_option.additional_properties = d
        return microsoft_asp_net_o_data_query_top_query_option
