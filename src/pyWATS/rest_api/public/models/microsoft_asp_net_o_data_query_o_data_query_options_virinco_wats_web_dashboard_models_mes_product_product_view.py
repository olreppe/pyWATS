...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view_if_none_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfNoneMatch
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view_request import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewRequest
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view_if_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfMatch
...
T = TypeVar("T", bound="MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductView")



@_attrs_define
class MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductView:
    """ 
        Attributes:
    ...
    if_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfMatch'] = UNSET
    if_none_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfNoneMatch'] = UNSET
    request: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewRequest'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfMatch]
        if isinstance(_if_match,  Unset):
            if_match = UNSET
        else:
            if_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfMatch.from_dict(_if_match)




        _if_none_match = d.pop("IfNoneMatch", UNSET)
        if_none_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfNoneMatch]
        if isinstance(_if_none_match,  Unset):
            if_none_match = UNSET
        else:
            if_none_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewIfNoneMatch.from_dict(_if_none_match)




        _request = d.pop("Request", UNSET)
        request: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewRequest]
        if isinstance(_request,  Unset):
            request = UNSET
        else:
            request = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesProductProductViewRequest.from_dict(_request)
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view = cls(
            if_match=if_match,
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view.additional_properties = d
        return microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_product_product_view
