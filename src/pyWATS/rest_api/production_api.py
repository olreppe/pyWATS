...
class ProductionApi:
    ...
    def get_unit(self, serial_number: str, part_number: str) -> Optional[Unit]:
        ...
        """
        response = self._http.get(f"/api/Production/Unit/{serial_number}/{part_number}")
    ...
    def create_or_update_units(
        ...
        """
        data = [
            u.model_dump(by_alias=True, exclude_none=True) if isinstance(u, Unit) else u
            for u in units
        ]
    ...
    def get_unit_verification(
        ...
        response = self._http.get("/api/Production/UnitVerification", params=params)
        if response.is_success and response.data:
    ...
    def set_unit_phase(
        ...
        response = self._http.put("/api/Production/SetUnitPhase", params=params)
    ...
    def set_unit_process(
        ...
        if comment:
            params["comment"] = comment
        response = self._http.put("/api/Production/SetUnitProcess", params=params)
        return response.is_success
    ...
    def get_unit_changes(
        ...
        if skip:
            params["$skip"] = skip
        response = self._http.get("/api/Production/Units/Changes", params=params if params else None)
        if response.is_success and response.data:
    ...
    def delete_unit_change(self, change_id: str) -> bool:
        ...
        Returns:
            True if successful
        """
        response = self._http.delete(f"/api/Production/Units/Changes/{change_id}")
        return response.is_success
    ...
    def add_child_unit(
        ...
        response = self._http.post("/api/Production/AddChildUnit", params=params)
        return response.is_success
    ...
    def remove_child_unit(
        ...
        response = self._http.post("/api/Production/RemoveChildUnit", params=params)
        return response.is_success
    ...
    def check_child_units(
        ...
        response = self._http.get("/api/Production/CheckChildUnits", params=params)
        if response.is_success and response.data:
    ...
    def get_serial_number_types(self) -> List[SerialNumberType]:
        ...
        if response.is_success and response.data:
            return [SerialNumberType.model_validate(item) for item in response.data]
        return []
    ...
    def take_serial_numbers(
        ...
        response = self._http.post("/api/Production/SerialNumbers/Take", params=params)
        if response.is_success and response.data:
    ...
    def get_serial_numbers_by_range(
        ...
        response = self._http.get("/api/Production/SerialNumbers/ByRange", params=params)
        if response.is_success and response.data:
    ...
    def get_serial_numbers_by_reference(
        ...
        response = self._http.get("/api/Production/SerialNumbers/ByReference", params=params)
        if response.is_success and response.data:
            return response.data if isinstance(response.data, list) else []
        return []
    ...
    def upload_serial_numbers(
        ...
        response = self._http.put("/api/Production/SerialNumbers", data=file_content, headers=headers)
        return response.is_success
    ...
    def export_serial_numbers(
        ...
        if format:
            params["format"] = format
        response = self._http.get("/api/Production/SerialNumbers", params=params)
    ...
    def create_or_update_batches(
        ...
        Returns:
            List of created/updated ProductionBatch objects
        """
        data = [
            b.model_dump(by_alias=True, exclude_none=True) if isinstance(b, ProductionBatch) else b
            for b in batches
        ]
        response = self._http.put("/api/Production/Batches", data=data)
        if response.is_success and response.data:
            return [ProductionBatch.model_validate(item) for item in response.data]
        return []
