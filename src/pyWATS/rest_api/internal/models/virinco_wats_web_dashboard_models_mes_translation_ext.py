...
T = TypeVar("T", bound="VirincoWATSWebDashboardModelsMesTranslationExt")



@_attrs_define
class VirincoWATSWebDashboardModelsMesTranslationExt:
    """ extended helper class to handle storeproc
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virinco_wats_web_dashboard_models_mes_translation_ext = cls(
        ...
        virinco_wats_web_dashboard_models_mes_translation_ext.additional_properties = d
        return virinco_wats_web_dashboard_models_mes_translation_ext
