...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header_request import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderRequest
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header_if_none_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfNoneMatch
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header_if_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfMatch
...
T = TypeVar("T", bound="MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeader")



@_attrs_define
class MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeader:
    """ 
        Attributes:
    ...
    if_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfMatch'] = UNSET
    if_none_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfNoneMatch'] = UNSET
    request: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderRequest'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfMatch]
        if isinstance(_if_match,  Unset):
            if_match = UNSET
        else:
            if_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfMatch.from_dict(_if_match)




        _if_none_match = d.pop("IfNoneMatch", UNSET)
        if_none_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfNoneMatch]
        if isinstance(_if_none_match,  Unset):
            if_none_match = UNSET
        else:
            if_none_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderIfNoneMatch.from_dict(_if_none_match)




        _request = d.pop("Request", UNSET)
        request: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderRequest]
        if isinstance(_request,  Unset):
            request = UNSET
        else:
            request = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsODataReportHeaderRequest.from_dict(_request)
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header = cls(
            if_match=if_match,
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header.additional_properties = d
        return microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_o_data_report_header
