...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_request import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetRequest
  from ..models.microsoft_asp_net_o_data_query_skip_query_option import MicrosoftAspNetODataQuerySkipQueryOption
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_if_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfMatch
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_if_none_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfNoneMatch
...
T = TypeVar("T", bound="MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAsset")



@_attrs_define
class MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAsset:
    """ 
        Attributes:
    ...
    if_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfMatch'] = UNSET
    if_none_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfNoneMatch'] = UNSET
    request: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetRequest'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfMatch]
        if isinstance(_if_match,  Unset):
            if_match = UNSET
        else:
            if_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfMatch.from_dict(_if_match)




        _if_none_match = d.pop("IfNoneMatch", UNSET)
        if_none_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfNoneMatch]
        if isinstance(_if_none_match,  Unset):
            if_none_match = UNSET
        else:
            if_none_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetIfNoneMatch.from_dict(_if_none_match)




        _request = d.pop("Request", UNSET)
        request: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetRequest]
        if isinstance(_request,  Unset):
            request = UNSET
        else:
            request = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetRequest.from_dict(_request)
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset = cls(
            if_match=if_match,
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset.additional_properties = d
        return microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset
