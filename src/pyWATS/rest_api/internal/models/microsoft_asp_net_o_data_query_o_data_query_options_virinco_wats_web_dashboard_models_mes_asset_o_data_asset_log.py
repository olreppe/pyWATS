...
if TYPE_CHECKING:
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log_request import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogRequest
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log_if_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfMatch
  ...
  from ..models.microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log_if_none_match import MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfNoneMatch





T = TypeVar("T", bound="MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLog")



@_attrs_define
class MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLog:
    """ 
        Attributes:
    ...
    if_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfMatch'] = UNSET
    if_none_match: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfNoneMatch'] = UNSET
    request: Union[Unset, 'MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogRequest'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfMatch]
        if isinstance(_if_match,  Unset):
            if_match = UNSET
        else:
            if_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfMatch.from_dict(_if_match)




        _if_none_match = d.pop("IfNoneMatch", UNSET)
        if_none_match: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfNoneMatch]
        if isinstance(_if_none_match,  Unset):
            if_none_match = UNSET
        else:
            if_none_match = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogIfNoneMatch.from_dict(_if_none_match)




        _request = d.pop("Request", UNSET)
        request: Union[Unset, MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogRequest]
        if isinstance(_request,  Unset):
            request = UNSET
        else:
            request = MicrosoftAspNetODataQueryODataQueryOptionsVirincoWATSWebDashboardModelsMesAssetODataAssetLogRequest.from_dict(_request)
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log = cls(
            if_match=if_match,
        ...
        microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log.additional_properties = d
        return microsoft_asp_net_o_data_query_o_data_query_options_virinco_wats_web_dashboard_models_mes_asset_o_data_asset_log
