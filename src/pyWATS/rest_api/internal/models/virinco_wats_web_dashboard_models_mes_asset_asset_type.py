...
T = TypeVar("T", bound="VirincoWATSWebDashboardModelsMesAssetAssetType")



@_attrs_define
class VirincoWATSWebDashboardModelsMesAssetAssetType:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        virinco_wats_web_dashboard_models_mes_asset_asset_type = cls(
            type_name=type_name,
            type_id=type_id,
        ...
        virinco_wats_web_dashboard_models_mes_asset_asset_type.additional_properties = d
        return virinco_wats_web_dashboard_models_mes_asset_asset_type
