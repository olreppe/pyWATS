...
from ...models.software_get_packages_by_tag_status import SoftwareGetPackagesByTagStatus
...
def _get_kwargs(
    *,
    tags: str,
    status: SoftwareGetPackagesByTagStatus,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/internal/Software/GetPackagesByTag",
        "params": params,
    }
