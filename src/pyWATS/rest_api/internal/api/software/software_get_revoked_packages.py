...
def _get_kwargs(
    *,
    ...
    include_revoked_only: Union[Unset, bool] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/internal/Software/GetRevokedPackages",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """ Return an array of packageIds that have been revoked.

    Args:
        installed_packages (str):
        include_revoked_only (Union[Unset, bool]):
...
include_revoked_only=include_revoked_only,
