...
Consolidated asset models for Manufacturing Execution System operations.
Combines comprehensive asset management models with MES-specific response types.

Moved from rest_api.models.asset for better domain separation.
"""
...
class AssetResponse(BaseModel):
    """Asset operation response model for MES operations.""" 
    model_config = ConfigDict(populate_by_name=True)
