"""About Page - Migrated with minimal changes (no config, simple display).

This page has no critical issues as it's read-only information display.
Added cleanup() for consistency with other pages.
"""
...
class AboutPage(BasePage):
    ...
    def _setup_ui(self) -> None:
        ...
        # Application name
        name_label = QLabel("pyWATS Configurator")
        ...
        try:
            ...
            version_text = "Version (development)"
        ...
        # Description
        desc_label = QLabel(
            "Configuration tool for pyWATS Client.\n\n"
            "Provides offline report storage, converter management,\n"
            "and integration with the WATS API.\n\n"
            "✨ New: Built on reliable framework with local queuing,\n"
            "auto-reconnect, and offline editing capabilities."
        )
        ...
        # Copyright footer
        copyright_label = QLabel("© 2026 pyWATS Contributors")
