...
"""
    ...
    current_user = "pyWATS_API_AUTOTEST"  # API test user
...
"""
            ...
            if result:
                ...
                print(f"  [!] Update returned None - trying status change via change_status")
                # Try using change_status directly
                result2 = wats_client.rootcause.change_status(d8_ticket.ticket_id, TicketStatus.SOLVED)
                if result2:
