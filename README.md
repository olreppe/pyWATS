...
**Quick Answer:** Can agents work in background branches while you work locally? **YES!** See:
- [Cheatsheet](docs/PARALLEL_WORK_CHEATSHEET.txt) - One-page reference (view: `cat docs/PARALLEL_WORK_CHEATSHEET.txt`)
- [Quick Reference: Parallel Work](docs/QUICK_REFERENCE_PARALLEL_WORK.md) - TL;DR guide
...
- [Example Script](docs/examples/parallel_branch_workflow.sh) - Interactive demonstration (run: `bash docs/examples/parallel_branch_workflow.sh`)
