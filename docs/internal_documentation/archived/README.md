...
⚠️ **This folder contains internal documentation that is NOT published with the pip package.**

This documentation is for:
- Developers contributing to pyWATS
- Architects understanding the system design
- AI agents with repository access
- Maintainers and release managers

## Architecture & Design

- **[ARCHITECTURE.md](ARCHITECTURE.md)** - Complete system architecture
- **[CONNECTION_ARCHITECTURE.md](CONNECTION_ARCHITECTURE.md)** - Connection layer design
- **[CONVERTER_ARCHITECTURE.md](CONVERTER_ARCHITECTURE.md)** - Converter system architecture
- **[STATION_ARCHITECTURE.md](STATION_ARCHITECTURE.md)** - Station implementation details
- **[STEP_GRAPH_MODEL.md](STEP_GRAPH_MODEL.md)** - Step graph data model

## Development Guides

- **[REST_API_INSTRUCTION.md](REST_API_INSTRUCTION.md)** - Internal API guidelines
- **[WATS_DOMAIN_KNOWLEDGE.md](WATS_DOMAIN_KNOWLEDGE.md)** - Domain knowledge for AI agents
- **[WATS_NEW_SPEC.md](WATS_NEW_SPEC.md)** - New API specifications

## Feature Documentation

- **[CONVERTER_REDESIGN.md](CONVERTER_REDESIGN.md)** - Converter redesign notes
- **[FRONTEND_COPILOT_MIGRATION.md](FRONTEND_COPILOT_MIGRATION.md)** - Migration documentation
- **[ALL_ANALYTICS_ENDPOINT_PUBLIC.md](ALL_ANALYTICS_ENDPOINT_PUBLIC.md)** - Analytics endpoint details

## Legacy Documentation

- **[api_specs/](api_specs/)** - OpenAPI specifications
- **[example_reports/](example_reports/)** - Sample report files
- **[gui_screens/](gui_screens/)** - GUI screenshots and mockups
- **[DOMAIN_STATUS/](DOMAIN_STATUS/)** - Development status tracking

## Published Documentation

For user-facing documentation that ships with the pip package, see:
- **[../](../)** - Published domain documentation (PRODUCT.md, ASSET.md, etc.)
- **[../usage/](../usage/)** - Detailed module usage guides
- **[../examples/](../examples/)** - Documentation code examples
- **[../INDEX.md](../INDEX.md)** - User documentation index

## Documentation Policy

**When creating new documentation:**

1. **User-facing API documentation** → Put in parent `docs/` folder
2. **Internal architecture/design** → Put in this `docs/internal/` folder
3. **Obsolete working notes** → Move to `docs/archive/`

This separation ensures:
- ✅ Clean pip packages with only relevant docs
- ✅ Clear distinction between public and internal
- ✅ Full context available in GitHub for developers
