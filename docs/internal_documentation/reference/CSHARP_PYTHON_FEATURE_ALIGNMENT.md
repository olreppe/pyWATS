...
| **Remove all children** | ✅ `RemoveAllChildUnits()` | ✅ `remove_all_children_from_assembly()` | **Equivalent**: Both have convenience method |
...
| **Assembly operations** | ✅ Add/Remove/RemoveAll | ✅ Add/Remove/RemoveAll (+ verify) | **Equivalent**: Both have full set |
...
- **Python approach is SUPERIOR**:
  ...
  - ✅ Complete assembly API (add/remove/remove_all/verify)
