...
namespace Virinco.WATS
{
    ...
    public class WATSException : Exception
    {
        ...
        {
            var cnv = new Virinco.Newtonsoft.Json.JsonSerializer();
    ...
    public class WATSLogMessage
    {
        ...
        public static void AppendLog(System.Data.SqlClient.SqlConnection cn, Virinco.WATS.WATSLogMessage message)
        {
            bool dblogged = false;
            try
            {
                if (cn != null)
                {
                    if (cn.State == System.Data.ConnectionState.Broken) cn.Close();
                    if (cn.State == System.Data.ConnectionState.Closed) cn.Open();
                    using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("wats.AddLog", cn))
                    {
            ...
            if (!dblogged || message.severity < Virinco.WATS.Logging.LogSeverity.ALERT)
            {
