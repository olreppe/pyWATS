...
Before moving a project to `completed/`:

- [ ] All tasks in TODO.md marked complete
- [ ] All tests passing
- [ ] README.md status updated to "✅ Complete"
- [ ] COMPLETION_SUMMARY.md created with final stats
- [ ] CHANGELOG.md updated (if applicable)
- [ ] Code committed and pushed
- [ ] Project folder moved to docs/internal_documentation/completed/{quarter}/
