...
class SubRepair(SubUnit):
    ...
    """
    parentIdx: Optional[int] = Field(default=None, deserialization_alias="parentIdx", serialization_alias="parentIdx")
    """
    ...
    """
    replacedIdx: Optional[int] = Field(default=None, deserialization_alias="replacedIdx", serialization_alias="replacedIdx")
    """
