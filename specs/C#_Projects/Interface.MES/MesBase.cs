    ...
    public class MesBase
    {
        ...
        private T[] getArr<T>(string[] keys)
        {
            ...
            if (keys != null)
            {
                ...
                if (res != null)
                {
                    Virinco.Newtonsoft.Json.Linq.JArray a = Virinco.Newtonsoft.Json.Linq.JArray.Parse(res.ToString());

                    foreach (Virinco.Newtonsoft.Json.Linq.JObject o in a.Children<Virinco.Newtonsoft.Json.Linq.JObject>())
                    {
