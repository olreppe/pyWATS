...
class TestAssetLog:
    ...
    def test_add_log_message(
        ...
        try:
            ...
            # API endpoint may not be available on all server configurations
            print(f"Add log message failed: {e}")
            pytest.skip(f"Asset log message endpoint not available: {e}")
