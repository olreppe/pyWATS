...
namespace Virinco.WATS
{
    public class Registry
    {
        ...
        public static string GetWATSRegistryValue(string keyName)
        {
            ...
            //{
                ...
                try
                {
                    ...
                    {
                        UIntPtr keyHandle;
                        long result = RegOpenKeyEx(HKEY_LOCAL_MACHINE, WATSRegistryPath, 0, KEY_QUERY_VALUE | KEY_WOW64_64KEY, out keyHandle);
        ...
        public static void SetWATSRegistryValue(string keyName, string stringValue)
        {
            ...
            {
                UIntPtr keyHandle;
                long result = RegOpenKeyEx(HKEY_LOCAL_MACHINE, WATSRegistryPath, 0, KEY_ALL_ACCESS  | KEY_WOW64_64KEY, out keyHandle);
                if (result == 0)
                {
                    try
                    {
