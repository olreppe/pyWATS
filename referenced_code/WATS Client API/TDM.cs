    ...
    public class TDM : IDisposable
    {
        ...
        */
        ...
        private XElement GetClientMiscInfo()
        {
            ...
            {
                // if no servicestatus-file exists, just add basic pending-info
        ...
        /// <summary>
        /// Add converters status elements from ServiceStatus.xml to the XElement
        /// </summary>
        /// <param name="e">XElement to add converter elements to</param>
        /// <returns>Returns true if file was found, parsed and elements copied, otherwise returns false</returns>
        private bool InsertServiceStatus(XElement e)
        {
            // Client-state, install states and converter status must be updated by service (using Client shared services)
        ...
        {
            throw new NotImplementedException("GetClientUpdateUri is no longer supported in Client Api");
            // Moved to WATS Client shared services
        }
