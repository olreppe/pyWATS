...
namespace Virinco.WATS.Service.MES.Contract
{
    ...
    public partial class Culture: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public short CultureId
        {
            ...
            set
            {
                if (_cultureId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'CultureId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _cultureId = value;
