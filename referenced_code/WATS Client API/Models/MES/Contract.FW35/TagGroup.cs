...
namespace Virinco.WATS.Service.MES.Contract
{
    ...
    public partial class TagGroup: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.Guid TagGroupId
        {
            ...
            set
            {
                if (_tagGroupId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'TagGroupId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _tagGroupId = value;
        ...
        private void FixupTags(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TagGroup, this))
                    {
                        item.TagGroup = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
