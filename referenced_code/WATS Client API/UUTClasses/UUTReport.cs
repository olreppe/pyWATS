...
namespace Virinco.WATS.Interface
{
    ...
    public class UUTReport : Report
    {
        ...
        public UUTPartInfo[] PartInfo
        {
            ...
            {
                //TODO: Discuss this
                var partInfos1 = reportRow.Items.OfType<PartInfo_type>().ToArray().Select(s => new UUTPartInfo(s, this));
                var partInfos2 = reportRow.Items.OfType<ReportUnitHierarchy_type>().ToArray().Select(s => new UUTPartInfo(s, this));
